...
type OpProgress struct {
	...
	BytesRead    int      `codec:"bytesRead" json:"bytesRead"`
	BytesWritten int      `codec:"bytesWritten" json:"bytesWritten"`
	FilesTotal   int      `codec:"filesTotal" json:"filesTotal"`
	FilesRead    int      `codec:"filesRead" json:"filesRead"`
	FilesWritten int      `codec:"filesWritten" json:"filesWritten"`
}
